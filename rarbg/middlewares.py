...
class ThreatDefenceRedirectMiddleware(RedirectMiddleware):
    ...
    def redirect_retry(self):
        ...
        link = self.driver.find_element(By.PARTIAL_LINK_TEXT, "Click")
    ...
    def find_solve_submit_captcha(self):
        ...
        captcha = self.driver.find_element(By.XPATH, "//img[contains(@src, 'captcha')]")
        ...
        input_field = self.driver.find_element(By.ID, "solve_string")
